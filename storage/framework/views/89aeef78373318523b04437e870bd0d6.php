<?php $__env->startSection('title', 'My Account — SE Shop'); ?>
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div class="flex items-center gap-5">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-200/70 mt-0.5"><?php echo e($user->email); ?></p>
                </div>
            </div>

            <div class="flex items-center gap-3">
                <?php if($user->isAdmin()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-sm bg-indigo-600 hover:bg-indigo-500 text-white border-0 gap-2">
                        <i class="bi bi-speedometer2"></i> Admin Panel
                    </a>
                <?php endif; ?>
                <a href="<?php echo e(route('shop.index')); ?>" class="btn btn-cyan btn-sm gap-2">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="stat-metric-card">
            <div class="flex items-center gap-3.5">
                ...
                <div>
                    <div class="text-2xl font-black text-white leading-none"><?php echo e($totalOrders); ?></div>
        ...
        <div class="stat-metric-card">
            <div class="flex items-center gap-3.5">
                ...
                <div>
                    <div class="text-2xl font-black text-white leading-none">$<?php echo e(number_format($totalSpent, 0)); ?></div>
        ...
        <div class="stat-metric-card">
            <div class="flex items-center gap-3.5">
                ...
                <div>
                    <div class="text-2xl font-black text-white leading-none"><?php echo e($activeOrders); ?></div>
        ...
        <div class="stat-metric-card">
            <div class="flex items-center gap-3.5">
                ...
                <div>
                    <div class="text-2xl font-black text-white leading-none capitalize"><?php echo e($user->role); ?></div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <?php if($orders->isEmpty()): ?>
                <div class="glass-panel p-16 text-center space-y-4">
                    ...
                    <a href="<?php echo e(route('shop.index')); ?>" class="btn btn-primary inline-flex gap-2">
                    ...
                    <div class="stat-metric-card p-5 space-y-4 hover:border-cyan-500/40 transition-all group">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
                            ...
                            <div class="space-y-0.5 text-right">
                                ...
                                <p class="text-xs font-semibold text-gray-300"><?php echo e($order->created_at->format('M d, Y')); ?></p>
                            </div>
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-sm font-black text-cyan-400">$<?php echo e(number_format($order->total_amount, 2)); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-1.5 mb-4">
                            <?php $__currentLoopData = $order->items->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="text-[10px] font-semibold text-gray-400 bg-gray-900/60 border border-gray-800 px-2.5 py-1 rounded-md">
                                    <?php echo e(Str::limit($item->product_name, 22)); ?> ×<?php echo e($item->quantity); ?>

                                </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if($order->items->count() > 3): ?>
                                <span class="text-[10px] text-gray-500 px-2 py-1">+<?php echo e($order->items->count() - 3); ?> more</span>
                            <?php endif; ?>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center gap-2.5 flex-wrap">
                            ...
                            <?php if($order->isCancelable()): ?>
                                <form action="<?php echo e(route('orders.cancel', $order->order_number)); ?>" method="POST"
                                    onsubmit="return confirm('Cancel order <?php echo e($order->order_number); ?>?');"
                                    class="inline">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="space-y-5">
            ...
            <div id="panel-profile" class="glass-panel p-6 space-y-5">
                ...
                <?php if(session('success') && session('tab') !== 'security'): ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] text-rose-400 mt-1"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl bg-gray-900/60 border border-gray-800">
                            <i class="bi bi-shield-check text-sm <?php echo e($user->isAdmin() ? 'text-indigo-400' : 'text-cyan-400'); ?>"></i>
                            <span class="text-xs font-bold text-white capitalize"><?php echo e($user->role); ?></span>
                            <span class="ml-auto badge <?php echo e($user->isAdmin() ? 'badge-indigo' : 'badge-cyan'); ?> text-[9px]">
                                <?php echo e($user->isAdmin() ? 'Admin' : 'Customer'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon-group">
                            ...
                            <input type="password" name="current_password" required
                                class="input-dark <?php echo e($errors->has('current_password') ? 'border-rose-500/70' : ''); ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon-group">
                            ...
                            <input type="password" name="new_password" required minlength="8"
                                class="input-dark <?php echo e($errors->has('new_password') ? 'border-rose-500/70' : ''); ?>">
                        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="glass-panel p-4 space-y-2">
                ...
                <a href="<?php echo e(route('shop.index')); ?>" class="flex items-center gap-3 p-2.5 rounded-lg hover:bg-gray-800/60 text-gray-400 hover:text-white transition-all text-xs font-semibold group">
                ...
                <a href="<?php echo e(route('orders.lookup')); ?>" class="flex items-center gap-3 p-2.5 rounded-lg hover:bg-gray-800/60 text-gray-400 hover:text-white transition-all text-xs font-semibold group">
...
<script>
    ...
    <?php if($errors->has('current_password') || $errors->has('new_password') || session('tab') === 'security'): ?>
        switchTab('security');
    <?php endif; ?>
</script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\YEAR IV\SEMESTER I\WB-III\project\my-laravel-app\resources\views/user/dashboard.blade.php ENDPATH**/ ?>