<?php $__env->startSection('title', 'Sign In — SE Shop'); ?>
...
<div class="min-h-[85vh] flex items-center justify-center py-16 px-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="auth-box space-y-7">
            ...
            <?php if(session('intended_message')): ?>
                <div class="alert alert-info animate-slide-in-up">
                    <i class="alert-icon bi bi-info-circle-fill"></i>
                    <p><?php echo e(session('intended_message')); ?></p>
                </div>
            <?php endif; ?>

            
            <form id="loginForm" action="<?php echo e(route('login')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon-group">
                        ...
                        <input id="email" name="email" type="email" required autocomplete="email"
                            ...
                            class="input-dark <?php echo e($errors->has('email') ? 'border-rose-500/70 focus:border-rose-500' : ''); ?>">
                    </div>
                </div>
                ...
                <p class="text-center text-xs text-gray-500">
                    New to SE Shop?
                    <a href="<?php echo e(route('register')); ?>" class="text-cyan-400 font-semibold hover:text-cyan-300 ml-1">Create a free account →</a>
                </p>
            </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\YEAR IV\SEMESTER I\WB-III\project\my-laravel-app\resources\views/auth/login.blade.php ENDPATH**/ ?>