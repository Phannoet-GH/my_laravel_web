            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <nav class="hidden md:flex items-center gap-6 text-sm font-semibold">
                        ...
                        <a href="<?php echo e(route('orders.lookup')); ?>" class="text-gray-300 hover:text-cyan-400 transition-colors inline-flex items-center gap-2 <?php echo e(request()->routeIs('orders.lookup') ? 'text-cyan-400 font-bold' : ''); ?>">
