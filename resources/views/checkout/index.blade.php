...
@section('title', 'Secure Checkout — SE Shop')
                        ...
                        <div class="sm:col-span-2 form-group">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="customer_name" value="{{ old('customer_name', $user->name ?? '') }}" required
                                    ...
                                    class="input-dark {{ $errors->has('customer_name') ? 'border-rose-500/70' : '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="email" name="customer_email" value="{{ old('customer_email', $user->email ?? '') }}" required
                                    ...
                                    class="input-dark {{ $errors->has('customer_email') ? 'border-rose-500/70' : '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="customer_phone" value="{{ old('customer_phone') }}" required
                                    ...
                                    class="input-dark {{ $errors->has('customer_phone') ? 'border-rose-500/70' : '' }}">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-2 form-group">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="shipping_address" value="{{ old('shipping_address') }}" required
                                    ...
                                    class="input-dark {{ $errors->has('shipping_address') ? 'border-rose-500/70' : '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="city" value="{{ old('city') }}" required
                                    ...
                                    class="input-dark {{ $errors->has('city') ? 'border-rose-500/70' : '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="postal_code" value="{{ old('postal_code') }}" required
                                    placeholder="94107"
                                    class="input-dark {{ $errors->has('postal_code') ? 'border-rose-500/70' : '' }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach([
                            ...
                            <label class="cursor-pointer select-none">
                                <input type="radio" name="payment_method" value="{{ $pm['value'] }}"
                                    {{ old('payment_method', 'card') === $pm['value'] ? 'checked' : '' }}
                                    class="peer sr-only">
                                <div class="p-4 rounded-xl bg-gray-900/70 border border-gray-800 peer-checked:border-blue-500 peer-checked:bg-blue-950/40 text-center space-y-2.5 transition-all hover:border-gray-700">
                                    <i class="bi {{ $pm['icon'] }} text-2xl {{ $pm['color'] }} block transition-transform peer-checked:scale-110"></i>
                                    <span class="text-xs font-bold text-gray-200 block">{{ $pm['label'] }}</span>
                                </div>
                            </label>
                        @endforeach
                    </div>
                ...
                <div class="glass-panel p-6 space-y-5 sticky-sidebar">
                    ...
                    <div class="space-y-3 max-h-56 overflow-y-auto pr-1 divide-y divide-gray-800/50">
                        @foreach($cart as $item)
                            <div class="pt-3 flex items-center gap-3 first:pt-0">
                                ...
                                <span class="text-xs font-bold text-white flex-shrink-0">${{ number_format($item['price'] * $item['quantity'], 2) }}</span>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="space-y-2.5 text-xs border-t border-gray-800/80 pt-4">
                        ...
                        <div class="flex justify-between items-baseline pt-3 border-t border-gray-800">
                            ...
                            <span class="text-2xl font-black text-cyan-400">${{ number_format($total, 2) }}</span>
                        </div>
                    </div>
