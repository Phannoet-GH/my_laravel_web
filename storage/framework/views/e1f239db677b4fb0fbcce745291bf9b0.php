<?php $__env->startSection('title', 'Shipping & Delivery Policy - SE Shop'); ?>
    ...
    <div class="space-y-8 text-gray-300 text-sm leading-relaxed">
        ...
        <div class="p-6 rounded-2xl bg-gray-900/60 border border-gray-800 space-y-3">
            ...
            <ul class="list-disc pl-5 space-y-1 text-xs text-gray-400">
                ...
                <li>Tracking links are dispatched automatically via email and available in your <a href="<?php echo e(route('orders.lookup')); ?>" class="text-cyan-400 hover:underline">Order Tracking Portal</a>.</li>
            </ul>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\YEAR IV\SEMESTER I\WB-III\project\my-laravel-app\resources\views/pages/shipping.blade.php ENDPATH**/ ?>