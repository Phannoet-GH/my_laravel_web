...
@section('title', 'Create Account — SE Shop')
        ...
        <div class="auth-box space-y-7">
            ...
            <form id="registerForm" action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon-group">
                        ...
                        <input id="password" name="password" type="password" required autocomplete="new-password"
                            placeholder="••••••••"
                            class="input-dark has-right-icon {{ $errors->has('password') ? 'border-rose-500/70' : '' }}"
                ...
                <p class="text-center text-xs text-gray-500">
                    ...
                    <a href="{{ route('login') }}" class="text-cyan-400 font-semibold hover:text-cyan-300 ml-1">Sign in →</a>
                </p>
            </form>
