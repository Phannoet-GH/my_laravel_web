<?php $__env->startSection('title', 'Official Invoice - ' . $order->order_number); ?>
    ...
    <div class="glass-panel p-8 border-gray-800 space-y-6">
        <div class="flex justify-between items-start border-b border-gray-800 pb-6">
            ...
            <div class="text-right">
                ...
                <p class="text-xs text-cyan-400 font-mono mt-1">Invoice #: <?php echo e($order->order_number); ?></p>
        ...
        <div class="grid grid-cols-2 gap-6 text-xs border-b border-gray-800 pb-6">
            <div>
                ...
                <p class="font-bold text-white text-sm"><?php echo e($order->customer_name); ?></p>
                <p class="text-gray-300"><?php echo e($order->shipping_address); ?></p>
                <p class="text-gray-300"><?php echo e($order->city); ?>, <?php echo e($order->postal_code); ?></p>
                <p class="text-gray-400 mt-1">Email: <?php echo e($order->customer_email); ?></p>
            </div>
            <div>
                <span class="text-gray-400 font-bold uppercase block mb-1">Payment Details</span>
                <p class="text-gray-300">Method: <strong class="text-white uppercase"><?php echo e($order->payment_method ?? 'CARD'); ?></strong></p>
                <p class="text-gray-300">Tracking Code: <strong class="text-cyan-400 font-mono"><?php echo e($order->tracking_code ?? 'TRK-PENDING'); ?></strong></p>
            </div>
        </div>
        ...
        <table class="w-full text-left text-xs text-gray-300">
            ...
            <tbody class="divide-y divide-gray-800/60">
                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="p-3 font-bold text-white"><?php echo e($item->product_name); ?></td>
                        <td class="p-3">$<?php echo e(number_format($item->unit_price, 2)); ?></td>
                        <td class="p-3"><?php echo e($item->quantity); ?></td>
                        <td class="p-3 text-right font-bold text-cyan-400">$<?php echo e(number_format($item->subtotal, 2)); ?></td>
                    </tr>
        ...
        <div class="max-w-xs ml-auto space-y-2 text-xs pt-4 border-t border-gray-800">
            <div class="flex justify-between text-gray-400">
                <span>Subtotal:</span>
                <span class="font-bold text-white">$<?php echo e(number_format($order->subtotal_amount ?? $order->total_amount, 2)); ?></span>
            </div>
            ...
            <div class="flex justify-between text-gray-400">
                <span>Tax (5%):</span>
                <span class="font-bold text-white">$<?php echo e(number_format($order->tax_amount ?? 0, 2)); ?></span>
            </div>
            <div class="flex justify-between text-sm font-bold text-white pt-2 border-t border-gray-800">
                <span>Total Paid:</span>
                <span class="text-xl font-black text-cyan-400">$<?php echo e(number_format($order->total_amount, 2)); ?></span>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\YEAR IV\SEMESTER I\WB-III\project\my-laravel-app\resources\views/orders/invoice.blade.php ENDPATH**/ ?>